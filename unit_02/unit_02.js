...
function t9() {
    let a9 = document.querySelector('.i-9');
    document.querySelector('.out-9').innerHTML = a9.value;
    a9.value = '';
...
function t10() {
    let a10 = document.querySelector('.out-10');
    let i10 = document.querySelector('.i-10');
    a10.innerHTML = i10.value * 20;
...
function t11() {
    let a11 = document.querySelector('.out-11');
    let i11 = document.querySelector('.i-11');
    a11.innerHTML = i11.value + 55;
