...
function f4() {
    let a4 = document.querySelector('.i-4');
...
function f5() {
    let a5 = document.querySelector('.i-5');
    let out5 = document.querySelector('.out-5');

    if (a5.checked) {
        out5.innerHTML = a5.value;
    } else {
...
function f9() {
    let a9 = document.querySelector('.r-9');
    let out9 = document.querySelector('.out-9');

    if (a9.checked) {
        out9.innerHTML = a9.value;
    } else {
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML = a12;
}
...
function f15() {
    ...
    document.querySelector('.t-15').innerHTML = a15;
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = a16;
}
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = a17;
}
...
function f20() {
    let a20 = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = a20;
}
