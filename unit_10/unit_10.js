...
let ar1 = [1, 2, 'Anatoli', true] // переменную обьявляем здесь!!!!
...
let ar2 = [1, 2, 'Anatoli', true] // переменную обьявляем здесь!!!!
...
let ar3 = [1, 2, 3, 4, 5, 6, 7, 5, 6, 7,]  // переменную обьявляем здесь!!!!
...
let ar4 = [1, 2, 3, 4, 5, 6, 7, 8, 9, 0] // переменную обьявляем эту здесь!!!!
...
// Вывод в out-5
// Тест допустим массив [9,2,3,4,5,6,7,8,9,10] вывод: 8

let ar5 = [9, 1, 3, 5, 6, 4, 3, 3, 45, 56, 6, 4, 3];
...
function f8() {
    ...
    let d = document.querySelector('.out-8-1');
    d.innerHTML = ar8.length;
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = d;
